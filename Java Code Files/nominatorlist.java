...
public class nominatorlist extends AppCompatActivity {
    ListView listView;
    ...
    // Server Http URL
   String HTTP_URL = "https://onlyforyou446.000webhostapp.com/nominilistfetch.php?Rg=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nominatorlist);
        ...
        StringRequest stringRequest = new StringRequest(HTTP_URL+Rg,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        new ParseJSonDataClass(nominatorlist.this).execute();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(nominatorlist.this,error.getMessage(),Toast.LENGTH_LONG).show();

                    }
                });

        // Creating String Request Object.
        RequestQueue requestQueue = Volley.newRequestQueue(nominatorlist.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               vote1=CustomSubjectNamesList.get(position).Subject_Vote;
                Intent a = new Intent(nominatorlist.this,vote.class);
            ...
            try {
                ...
                if (FinalJSonObject != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(context, "NO ONE STANDS FROM YOUR AREA", Toast.LENGTH_LONG).show();
