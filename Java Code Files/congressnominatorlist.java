...
public class congressnominatorlist extends AppCompatActivity {
    ListView listView;

    Button button;

    // Server Http URL
String HTTP_URL = "https://onlyforyou446.000webhostapp.com/congress.php?Rg=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_congressnominatorlist);
        ...
        StringRequest stringRequest = new StringRequest(HTTP_URL+Rg,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        new ParseJSonDataClass(congressnominatorlist.this).execute();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(congressnominatorlist.this,error.getMessage(),Toast.LENGTH_LONG).show();

                    }
                });

        // Creating String Request Object.
        RequestQueue requestQueue = Volley.newRequestQueue(congressnominatorlist.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent a = new Intent(congressnominatorlist.this,vote.class);
