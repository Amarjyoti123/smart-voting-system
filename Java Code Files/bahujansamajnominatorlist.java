...
public class bahujansamajnominatorlist extends AppCompatActivity {
    ListView listView;
    String Rg;
    ...
    // Server Http URL
     String HTTP_URL = "https://onlyforyou446.000webhostapp.com/bsp.php?Rg=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bahujansamajnominatorlist);
        ...
        StringRequest stringRequest = new StringRequest(HTTP_URL+Rg,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        new ParseJSonDataClass(bahujansamajnominatorlist.this).execute();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(bahujansamajnominatorlist.this,error.getMessage(),Toast.LENGTH_LONG).show();

                    }
                });

        // Creating String Request Object.
        RequestQueue requestQueue = Volley.newRequestQueue(bahujansamajnominatorlist.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent a = new Intent(bahujansamajnominatorlist.this,vote.class);
