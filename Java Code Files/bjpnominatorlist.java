...
public class bjpnominatorlist extends AppCompatActivity {
    ListView listView;
    String Rg;
    ...
    // Server Http URL
    String HTTP_URL = "https://onlyforyou446.000webhostapp.com/bjpnominationlist.php?Rg=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bjpnominatorlist);
        ...
        StringRequest stringRequest = new StringRequest(HTTP_URL+Rg,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        new ParseJSonDataClass(bjpnominatorlist.this).execute();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(bjpnominatorlist.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent a = new Intent(bjpnominatorlist.this,vote.class);
